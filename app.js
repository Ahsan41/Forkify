// var itemList = document.querryselector(`.left`)
// var searchBar = document.querryselector(`.searchBar`)
// var searchBtn = document.querryselector(`.searchBtn`)
// var productDetails = document.querryselector(`.productDetails`)
